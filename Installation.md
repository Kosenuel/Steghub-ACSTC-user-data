...
openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout /etc/ssl/private/kos.key -out /etc/ssl/certs/kos.crt
...
openssl req -newkey rsa:2048 -nodes -keyout /etc/pki/tls/private/kos.key -x509 -days 365 -out /etc/pki/tls/certs/kos.crt
...
mysql -h database-1.cdqpbjkethv0.us-east-1.rds.amazonaws.com -u admin -p
